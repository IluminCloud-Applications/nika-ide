...
// Same-origin: the API is reached via relative "/api" (no VITE_API_URL / CORS).
    ...
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-background text-foreground p-4 relative overflow-hidden">
      ...
      <Card className="w-full max-w-[360px] border-border/50 bg-card/40 backdrop-blur-md shadow-2xl relative z-10">
        <CardHeader className="space-y-1 text-center pb-4">
          <CardTitle className="text-xl font-bold tracking-tight">Acesse sua conta</CardTitle>
          <CardDescription className="text-xs">Bem-vindo de volta! Faça login para continuar</CardDescription>
        </CardHeader>
        <CardContent>
